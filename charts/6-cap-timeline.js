    ...
    const spec = {
      ...
      "data": [
        {
          "name": "table",
          "values": [
            {"year": "2019", "cap": 996100,  "adj": 5279330 },
            {"year": "2020", "cap": 1300000, "adj": 6890000},
            {"year": "2021", "cap": 1339000, "adj": 7096700},
            {"year": "2022", "cap": 1379200, "adj": 7309760},
            {"year": "2023", "cap": 1420500, "adj": 7528650},
            {"year": "2024", "cap": 1463200, "adj": 7754960},
            {"year": "2025", "cap": 1507100, "adj": 7987630}
          ]
        },
        {
          "name": "ends",
        ...
        },
        {
          "name": "anno",
          "values": [
            {"year": "2022", "y": 4300000, "text": "Room a fairer cap would unlock"}
          ]
        }
      ],
      ...
      "axes": [
        ...
        },
        {
          ...
          "labelFontSize": 12,
          "labelColor": "#666",
          "values": [1000000, 2000000, 3000000, 4000000, 5000000, 6000000, 7000000, 8000000],
          "encode": {
            "labels": {
              "update": {
                "text": {
                  "signal": "datum.value === 0 ? '' : '$' + format(datum.value / 1000000, '.0f') + 'M'"
                },
                "fill": {"value": "#666"},
